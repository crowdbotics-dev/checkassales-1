"""
Django settings for checkassales_1 project.
...
ROOT_URLCONF = 'checkassales_1.urls'
...
WSGI_APPLICATION = 'checkassales_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "checkassales_1 API",
    "DESCRIPTION": "API documentation for checkassales_1 App",
    "VERSION": "v1",
}
